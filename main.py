...
point_amt = "POINTS: "
points = 5
display_points = my_font.render(point_amt + str(points), True, (255, 255, 255))
...
while run:
    ...
    if ninja.rect.collidepoint(cactus):
        points = points - 1
    ...
    screen.blit(display_points, (135, 215))
    for i in obstacles:
            screen.blit(i.image, i.rect)
            i.move_obstacle(i)
            if i.x < 0:
                i.reset_obstacle(880)
